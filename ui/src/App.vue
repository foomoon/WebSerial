  ...
  <div id="app">
    <div class="container mt-2">
      <div class="row justify-content-center my-5">
        <div class="col-auto text-center data-logger-logo">
                ...
                <div class="row justify-content-center">
                  <div class="col-12">
                    <div class="form-group mt-3">
                      <textarea id="console" class="form-control" rows="13" v-model="serialBuffer" readonly="readonly"></textarea>
                    </div>
                  </div>
                  <div>
                    <div class="custom-control custom-toggle my-2">
                      <input type="checkbox" id="customToggle1" name="customToggle1" class="custom-control-input" v-model="isScroll" >
                      <label class="custom-control-label" for="customToggle1">Auto-scroll</label>
                    </div>
                  </div>
...
export default {
  ...
  mounted(){
    ...
    Socket.$on("disconnected", () => {
      ...
      this.serialBuffer = "disconnected";
    });
...
.data-logger-logo img {
  object-fit: cover;
  width: 100px;
  height: 100px;
  object-position: 0 0;
}
.data-logger-logo span {
  font-size: 2.8em;
